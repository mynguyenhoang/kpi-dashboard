        ...
        def clean_val(row_idx, col_idx):
            try:
                if row_idx < len(vals) and col_idx < len(vals[row_idx]):
                    ...
                    # Nếu ô trống, hoặc dính công thức lỗi -> Trả về NaN
...
# BIỂU ĐỒ - XÓA SẠCH CHỮ 'NAN' TRONG LABEL
...
with c_t2:
    ...
    # Xóa chữ nan cho biểu đồ cột ghép
...
with st.expander("Bảng đối soát dữ liệu thô"):
    # Ép tất cả các thể loại trống thành chuỗi rỗng để bảng hiển thị trắng tinh
